...
public class RNCWebViewMT extends WebView implements LifecycleEventListener {
        ...
        if (sendContentSizeChangeEvents) {
            dispatchEvent(
                    ...
                    new ContentSizeChangeEvent(
                            RNCWebViewWrapperMT.getReactTagFromWebView(this),
                            w,
                            h
                    )
            );
          ...
          RNCWebView.this.evaluateJavascript(
            ...
            new ValueCallback<String>() {
              ...
              public void onReceiveValue(String selectionJson) {
                ...
                dispatchEvent(RNCWebView.this, new TopCustomMenuSelectionEvent(RNCWebViewWrapperMT.getReactTagFromWebView(RNCWebView.this), wMap));
                mode.finish();
              }
            }
          );
    ...
    public void onMessage(String message, String sourceUrl) {
        ...
        if (mRNCWebViewClient != null) {
            ...
            webView.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mMessagingJSModule != null) {
                        ...
                        dispatchEvent(webView, new TopMessageEvent(RNCWebViewWrapperMT.getReactTagFromWebView(webView), data));
                    }
                }
            });
        } else {
            ...
            if (mMessagingJSModule != null) {
                ...
                dispatchEvent(this, new TopMessageEvent(RNCWebViewWrapperMT.getReactTagFromWebView(this), eventData));
            }
        }
    }
    ...
    protected void dispatchEvent(WebView webView, Event event) {
        ThemedReactContext reactContext = getThemedReactContext();
        int reactTag = RNCWebViewWrapperMT.getReactTagFromWebView(webView);
  ...
  protected class RNCWebViewBridge {
        ...
        RNCWebViewBridge(RNCWebViewMT c) {
          mWebView = c;
        }
